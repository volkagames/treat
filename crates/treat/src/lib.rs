...
//!
//! `treat` gives you one response shape for success *and* failure, errors that
...
pub mod prelude {
    pub use treat_core::prelude::*;
    // Re-export the derive macros so that `use treat::prelude::*` brings both the
