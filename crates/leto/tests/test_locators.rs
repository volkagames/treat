...
fn openapi_schemas_generate_for_envelope() {
    ...
    let _error_response = leto::ErrorResponse::schema();
    let _error_message = leto::ErrorMessage::schema();
    let _source = leto::ErrorSource::schema();
    let _envelope = leto::ApiResponse::<String, String>::schema();
}
